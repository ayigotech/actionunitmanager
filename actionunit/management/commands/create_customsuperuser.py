...
from actionunit.models import Church

User = get_user_model()

class Command(BaseCommand):
    help = 'Create a superuser for ActionUnitManager system'

    def handle(self, *args, **options):
        self.stdout.write("Creating superuser for ActionUnitManager...")
